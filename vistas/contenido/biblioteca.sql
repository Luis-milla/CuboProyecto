...
CREATE TABLE `empleado` (
  ...
  `correoem` text DEFAULT NULL,
  PRIMARY KEY (`id_empleado`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4;

/*Data for the table `empleado` */

insert  into `empleado`(`id_empleado`,`nombre`,`apellido`,`estado`,`fecha_registro`,`foto`,`nivel`,`claveem`,`correoem`) values 
(11,'Luis','Rivas','A','2022-01-01',NULL,1,'N1pybDBXYWZDYXJZWEtBNEZQWWszQT09','rivas@gmail.com'),
(13,'Luis','Rivas','A','2022-01-01',NULL,1,'d2xaN2YyeWVVOStIa0EvSHBxMEVnZz09','vane@gmail.com'),
(14,'Luis','Rivas2','A','2022-01-01',NULL,1,'YVFmcXlKbHFKZDdNVERUV0xSeGZ1Zz09','riv@gmail.com');
